...
namespace cadet
{
	...
	public:
		...
		void init(std::string limiter, const double eps, const double r, const double gamma, const unsigned int nCells, const unsigned int nComp, const bool trackTroubledCells = false) {
